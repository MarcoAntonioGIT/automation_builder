            ...
            <div className="flex items-center flex-col">
              ...
              >
                ...
                bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                  Automatize seu trabalho com Weavier
                </h1>
            </div>
          }
        />
    ...
    <section className="mt-[-500px]">
      ...
      <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black 
          dark:border-white/[0.2] border-black/[0.1 w-full md:!w[350px] h-auto rounded-xl p-6 border">
            <CardItem
              translateZ="50"
            ...
            >
              ...
              Experimente o que nosso software é capaz. 
              <ul className="my-4 flex flex-col gap-2">
                <li className="flex items-center gap-2">
                  <CheckIcon />3 Automações Grátis
                </li>
                <li className="flex items-center gap-2">
                  <CheckIcon/>100 tarefas por mês
                </li>
                <li className="flex items-center gap-2">
        ...
        <CardContainer className="inter-var">
          <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1] dark:bg-black 
          dark:border-[#E2CBFF] border-black/[0.1] w-full md:!w[350px] h-auto rounded-xl p-6 border">
            <CardItem
              translateZ="50"
              className="text-xl font-bold text-neutral-600 dark:text-white"
            >
              Pro
              <h2 className="text-6xl">R$79</h2>
              Experimente o que nosso software é capaz. 
              <ul className="my-4 flex flex-col gap-2">
                <li className="flex items-center gap-2">
                  <CheckIcon />3 Automações Grátis
        ...
        <CardContainer className="inter-var">
          ...
          dark:border-white/[0.2] border-black/[0.1 w-full md:!w[350px] h-auto rounded-xl p-6 border">
            ...
            >
              Ilimitado
              <h2 className="text-6xl">R$199</h2>
              Experimente o que nosso software é capaz. 
              <ul className="my-4 flex flex-col gap-2">
                <li className="flex items-center gap-2">
                  <CheckIcon />3 Automações Grátis
